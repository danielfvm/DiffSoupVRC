          ...
          for (int j = 2; j < nj; ++j) {
            ...
            foreach (int g in abc) {
              ...
              if (global_to_local.ContainsKey(g)) {
                ...
                vertices.Add(new Vector3(pv[prop_x][g], pv[prop_z][g], pv[prop_y][g])); // Flipped axis here!
                if (!no_nxyz) normals.Add(new Vector3(pv[prop_nx][g], pv[prop_nz][g], pv[prop_ny][g]));
